...
public class RoboflowFrameProcessorPlugin: NSObject, FrameProcessorPluginBase {
  ...
  static let rf = RoboflowMobile(apiKey: "mbDpagHG5W1A2JwZKYfR")
  ...
  public static func callback(_ frame: Frame!, withArgs _: [Any]!) -> Any! {
    ...
    if self.model != nil {
      ...
      loadRoboflowModelWith(model: "playing-cards-ow27d", version: 4/*insert your model version here*/, threshold: 0.5, overlap: 0.5, maxObjects: 20.0)
    }
